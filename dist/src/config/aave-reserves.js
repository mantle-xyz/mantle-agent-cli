 ...
 */
export const AAVE_V3_MANTLE_RESERVES = [
    {
        id: 0,
        symbol: "WETH",
...
export function isolationModeSymbols() {
...
export function isolationBorrowableSymbols() {
